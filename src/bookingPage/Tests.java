...
//	        driver.findElement(By.xpath(Bookingpage.BookTab)).click();
	  ...
	  {    bookingType = "classes";
		   ...
		   // Click to choose class    /html/body/div[7]/div/div[2]/div[2]/div[2]/div[4]/div[2]/ul/ul[2]/ul/li/div[2]/b 		
		   driver.findElement(By.xpath("/html/body/div[7]/div/div[2]/div[2]/div[2]/div[4]/div[2]/ul/ul[2]/ul/li/div[2]/b")).click();
...
public void classes()
{
	...
	Log.info("Enter Customer Name");					
	driver.findElement(By.xpath("/html/body/div[7]/div/div[2]/div[2]/div[2]/div[4]/div[5]/form/div[1]/ul/li[3]/div[1]/input")).sendKeys("Vimal Tester");					
	Log.info("Customer Nameclicked");
