...
public class Create_NewAccount {
...

	{
		...
		driver.findElement(By.xpath(".//*[@id='email-signup']")).sendKeys("Create1s23456d789@setmore.com");
...

	{
		...
		// driver.findElement(By.xpath(".//*[@id='setup-business-sa']/div[1]/div[1]/a")));
...

	{
		...
		// driver.findElement(By.xpath(".//*[@id='setup-staffname']")).sendKeys("Staff
		// Two");
