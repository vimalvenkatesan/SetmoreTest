...
public class auto {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		driver.findElement(By.xpath(
				...
				.click();
		driver.findElement(By.xpath(
				"//android.widget.RelativeLayout[1]/android.view.View[2]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[1]/android.widget.LinearLayout[1]"))
				.click();
		driver.findElement(By.xpath(
