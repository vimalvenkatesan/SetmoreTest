...
public class singlesession {
	...
	public void Login() {
		...
		driver.get(Constant.Navyabuild);
		Log.info("Singin started");
		driver.findElement(By.id("username")).sendKeys("bharathi@setmore.com");
		driver.findElement(By.id("password")).sendKeys("bharathi@setmore.com");
	...
	public void createservices() throws InterruptedException {
		...
		// Boolean isPresent =
		// driver.findElements(By.xpath(".//*[@id='noClass']/button")).size() >
		// 0;
...

		{
			...
			// Click class id
			driver.findElement(By.xpath(".//*[@id='ca633b1421665233134']/div[3]")).click();
			...
			for (int j = 1; j <= 100; j++) {
				...
				driver.findElement(By.xpath(".//*[@id='editClassApptPopup']/div[2]/ul/li[5]/div[1]/ul/li/div[1]"))
						.click();
				...
				driver.findElement(By.xpath("//*[@id='editClassApptPopup']/div[2]/ul/li[5]/div[1]/ul/li/div[1]/a"))
						.click();
				Thread.sleep(2000);
				driver.findElement(By.xpath("//*[@id='editClassApptPopup']/div[2]/ul/li[5]/div[1]/ul/li/div[1]"))
						.click();
				...
				WebElement nextArrow = lastPicker.findElement(
						By.xpath(".//div[@class='datepickerContainer']/table/tbody/tr/td/table/thead/tr[1]/th[3]/a"));

				for (int i = 1; i <= 3; i++) {
					nextArrow.click();
				}
				// WebElement date30May =
				// lastPicker.findElement(By.xpath(".//div[@class='datepickerContainer']/table/tbody/tr/td/table/tbody[2]/tr[4]/td[2]"));

				WebElement July = lastPicker.findElement(By
						.xpath(".//div[@class='datepickerContainer']/table/tbody/tr/td/table/tbody[2]/tr[5]/td[3]/a"));
				July.click();
